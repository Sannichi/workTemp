...
//		currencyMap.put(CURRENCY_SIGNS.BND, new CurrencyDescription(7, 14, 28, 70, 84, 175, 420, 560, 840, 1120, 1680, "$", CurrencyUtils.getConversionRate(CURRENCY_SIGNS.BND)));
		...
		currencyMap.put(CURRENCY_SIGNS.EUR, new CurrencyDescription(5, 10, 20, 50, 60, 125, 300, 400, 600, 800, 1200, "â‚¬", CurrencyUtils.getConversionRate(CURRENCY_SIGNS.EUR)));currencyMap.put(CURRENCY_SIGNS.EUR, new CurrencyDescription(5, 10, 19, 46, 55, 114, 273, 364, 546, 728, 1092, "€", CurrencyUtils.getConversionRate(CURRENCY_SIGNS.EUR)));
		currencyMap.put(CURRENCY_SIGNS.INR, new CurrencyDescription(350, 700, 1500, 3500, 4000, 8500, 20000, 27000, 40000, 55000, 80000, "₹", CurrencyUtils.getConversionRate(CURRENCY_SIGNS.INR)));
		...
		currencyMap.put(CURRENCY_SIGNS.SAR, new CurrencyDescription(20, 40, 75, 200, 250, 470, 1125, 1500, 2250, 3000, 4500, "ï·¼", CurrencyUtils.getConversionRate(CURRENCY_SIGNS.SAR)));
		...
		currencyMap.put(CURRENCY_SIGNS.GBP, new CurrencyDescription(5, 10, 20, 50, 60, 125, 300, 400, 600, 800, 1200, "Â£", CurrencyUtils.getConversionRate(CURRENCY_SIGNS.GBP)));
