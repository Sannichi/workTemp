...
//		int aedPrice, int gbpPrice, int kwdPrice, int myrPrice, int sgdPrice, int aoaPrice, int bndPrice, CURRENCY_SIGNS currencySign, int minutes)
		...
		dealMap.put(LOCALE_CONST.INDIA_DEAL_350, new DealDescription(		(float) 7.99, 12, 12, 8, 541, 13, 29, 30, 30, 6, (float) 2.4, 35, 12, 1238, 12, CURRENCY_SIGNS.INR, 350, 200));
		dealMap.put(LOCALE_CONST.INDIA_DEAL_550, new DealDescription(		(float) 9.99, 15, 15, 10, 677, 16, 36, 38, 37, 7, (float) 3.0, 43, 15, 1547, 14, CURRENCY_SIGNS.INR, 550, 200));		
		dealMap.put(LOCALE_CONST.INDIA_DEAL_800, new DealDescription(		(float) 11.99, 18, 18, 12, 812, 19, 44, 45, 45, 9, (float) 3.6, 52, 18, 1857, 17, CURRENCY_SIGNS.INR, 800, 200));
