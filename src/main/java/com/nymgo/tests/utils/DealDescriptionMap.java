...
//				(float) 4.5, (float) 66, (float) 22, (float) 2321, (float) 22, CURRENCY_SIGNS.INR, 1000, 200));
		dealMap.put(LOCALE_CONST.INDIA_DEAL_350, new DealDescription(		(float) 7.99, (float) 10.7, (float) 10.7, (float) 7.2, (float) 537.5, 
				(float) 12.1, (float) 29.1, (float) 30.0, (float) 29.3, (float) 5.6, 		
				(float) 2.4, (float) 33.0, (float) 11.0, (float) 1263.6, (float) 10.9, CURRENCY_SIGNS.INR, 350, 200));
...
//		dealMap.put(LOCALE_CONST.BANGLADESH_DEAL_1120, new DealDescription(	(float) 22.99, 	31, 22, 14, 1016, 24, 54, 57, 56, 11, 	(float) 4.5, 64, 22, 2323, 21, CURRENCY_SIGNS.BDT, 600, 200));
		dealMap.put(LOCALE_CONST.BANGLADESH_DEAL_1150, new DealDescription(	(float) 22.99, (float) 30.8, (float) 30.8, (float) 20.7, (float) 1546.5, 
				(float) 34.7, (float) 83.7, (float) 86.2, (float) 84.4, (float) 16.1, 	
				(float) 6.9, (float) 94.9, (float) 31.7, (float) 3635.9, (float) 31.3, CURRENCY_SIGNS.BDT, 1150, 200));
...
//		dealMap.put(LOCALE_CONST.INDONESIA_DEAL_480, new DealDescription(	(float) 20.49, 	28, 22, 14, 1016, 24, 54, 57, 56, 11, 	(float) 4.5, 64, 22, 2323, 21, CURRENCY_SIGNS.IDR, 300, 20000));
		dealMap.put(LOCALE_CONST.INDONESIA_DEAL_540, new DealDescription(	(float) 19.99, (float) 26.8, (float) 26.8, (float) 18.0, (float) 1344.7, 
				(float) 30.2, (float) 72.8, (float) 75.0, (float) 73.4, (float) 14.0, 	
				(float) 6.0, (float) 82.6, (float) 27.6, (float) 3161.4, (float) 27.2, CURRENCY_SIGNS.IDR, 540, 20000));
...
//		dealMap.put(LOCALE_CONST.PAKISTAN_DEAL_240, new DealDescription(	(float) 8.49, 	12, 15, 10, 677, 16, 36, 38, 37, 7, 	(float) 3.0, 43, 15, 1549, 14, CURRENCY_SIGNS.PKR, 300, 300));
		dealMap.put(LOCALE_CONST.PAKISTAN_DEAL_250, new DealDescription(	(float) 6.99, (float) 9.4, (float) 9.4, (float) 6.3, (float) 470.2, 
				(float) 10.6, (float) 25.4, (float) 26.2, (float) 25.7, (float) 4.9, 	
				(float) 2.1, (float) 28.9, (float) 9.6, (float) 1105.5, (float) 9.5, CURRENCY_SIGNS.PKR, 250, 200));
...
//		int kwdPrice, int myrPrice, int sgdPrice, int aoaPrice, int bndPrice, CURRENCY_SIGNS currencySign, int minutes)
		...
		dealMap.put(LOCALE_CONST.YEMEN_DEAL_260, new DealDescription(		(float) 29.99, (float) 40.2, (float) 40.2, (float) 27.0, (float) 2017.4, 
//				(float) 44.1, (float) 109.2, (float) 112.5, (float) 110.1, (float) 21.0, 	
				(float) 45.3, (float) 109.2, (float) 112.5, (float) 110.1, (float) 21.0, 	
				(float) 9.0, (float) 123.9, (float) 41.4, (float) 4742.9, (float) 40.8, CURRENCY_SIGNS.YER, 260, 345));
...
//		dealMap.put(LOCALE_CONST.SYRIA_DEAL_120, new DealDescription(		(float) 12.99, 	18, 29, 19, 1354, 31, 72, 75, 74, 14, 	(float) 6.0, 86, 29, 3097, 28, CURRENCY_SIGNS.SYP, 200, 300));		
		dealMap.put(LOCALE_CONST.SYRIA_DEAL_180, new DealDescription(		(float) 13.99, (float) 18.7, (float) 18.7, (float) 12.6, (float) 941.1, 
				(float) 21.1, (float) 50.9, (float) 52.5, (float) 51.3, (float) 9.8, 	
				(float) 4.2, (float) 57.8, (float) 19.3, (float) 2212.5, (float) 19.0, CURRENCY_SIGNS.SYP, 180, 300));		
...
//		dealMap.put(LOCALE_CONST.EGYPT_DEAL_320, new DealDescription(		(float) 9.25, 	21, 16, 11, 745, 17, 40, 42, 41, 8, 	(float) 3.3, 47, 16, 1704, 16, CURRENCY_SIGNS.EGP, 200, 20));
		...
		dealMap.put(LOCALE_CONST.NIGERIA_DEAL_40, new DealDescription(		(float) 3.99, (float) 5.3, (float) 5.3, (float) 3.6, (float) 268.4, 
				(float) 6.0, (float) 14.5, (float) 15.0, (float) 14.6, (float) 2.8, 	
				(float) 1.2, (float) 16.5, (float) 5.5, (float) 631.0, (float) 5.4, CURRENCY_SIGNS.NGN, 40, 500));
...
//		int kwdPrice, int myrPrice, int sgdPrice, int aoaPrice, int bndPrice, CURRENCY_SIGNS currencySign, int minutes)
		...
		dealMap.put(LOCALE_CONST.KENYA_DEAL_320, new DealDescription(		(float) 32.99, (float) 44.2, (float) 44.2, (float) 29.7, (float) 2219.2, 
				(float) 49.8, (float) 120.1, (float) 123.7, (float) 121.1, (float) 23.1, 	
				(float) 9.9, (float) 136.2, (float) 45.5, (float) 5217.4, (float) 44.9, CURRENCY_SIGNS.KES, 320, 300));
...
//		dealMap.put(LOCALE_CONST.NEPAL_DEAL_240, new DealDescription(		(float) 23.99, 	33, 32, 21, 1490, 34, 80, 83, 81, 16, 	(float) 6.6, 94, 32, 3407, 31, CURRENCY_SIGNS.NPR, 200, 200));
		dealMap.put(LOCALE_CONST.NEPAL_DEAL_260, new DealDescription(		(float) 22.99, (float) 30.8, (float) 30.8, (float) 20.7, (float) 1546.5, 
				(float) 34.7, (float) 83.7, (float) 86.2, (float) 84.4, (float) 16.1, 	
				(float) 6.9, (float) 94.9, (float) 31.7, (float) 3635.9, (float) 31.3, CURRENCY_SIGNS.NPR, 260, 200));
...
//		dealMap.put(LOCALE_CONST.SRI_LANKA_DEAL_130, new DealDescription(	(float) 20.99, 	29, 25, 16, 1151, 27, 62, 64, 63, 12, 	(float) 5.1, 73, 25, 2633, 24, CURRENCY_SIGNS.LKR, 100, 200));
		dealMap.put(LOCALE_CONST.SRI_LANKA_DEAL_180, new DealDescription(	(float) 22.99, (float) 30.8, (float) 30.8, (float) 20.7, (float) 1546.5, 
				(float) 34.7, (float) 83.7, (float) 86.2, (float) 84.4, (float) 16.1, 	
				(float) 6.9, (float) 94.9, (float) 31.7, (float) 3635.9, (float) 31.3, CURRENCY_SIGNS.LKR, 180, 200));
...
//		dealMap.put(LOCALE_CONST.PHILIPPINES_DEAL_100, new DealDescription(	(float) 17, 	25, 25, 16, 1151, 27, 62, 64, 63, 12, 	(float) 5.1, 73, 25, 2633, 24, CURRENCY_SIGNS.PHP, 100, 300));
		dealMap.put(LOCALE_CONST.PHILIPPINES_DEAL_150, new DealDescription(	(float) 16.99, (float) 22.8, (float) 22.8, (float) 15.3, (float) 1142.9, 
				(float) 25.7, (float) 61.8, (float) 63.7, (float) 62.4, (float) 11.9, 	
				(float) 5.1, (float) 70.2, (float) 23.4, (float) 2687.0, (float) 23.1, CURRENCY_SIGNS.PHP, 150, 100));
	}
